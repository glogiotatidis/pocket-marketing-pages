  ...
  [35],
  {
    Eh6L: function (e, t, o) {
      ...
      (t.a = function (e) {
        ...
        return h(
          ...
          h(l.a, { isLoggedIn: r }),
          h(c.u, { className: "page-container" }, h("main", null, t)),
          h(c.l, { hasColorBorder: !0 })
        );
      }),
        o("jl8r");
    },
    ...
    "hiz+": function (e, t, o) {
      ...
      function h() {
        return l(
          c.a,
          { title: "Pocket: Terms of Service" },
          l("h1", null, "Terms of Service"),
          l("h5", null, l("em", null, "Posted January 5, 2021")),
          l(
            "p",
            null,
          ...
          l(
            "ul",
            null,
            l("li", null, l("a", { href: "#service" }, "The Pocket Service")),
            l("li", null, l("a", { href: "#grant" }, "License Grant")),
            l("li", null, l("a", { href: "#ownership" }, "Ownership")),
            l(
              "li",
              null,
              l("a", { href: "#restrictions" }, "License Restrictions")
            ),
            l("li", null, l("a", { href: "#info" }, "Information You Provide")),
            l(
              "li",
              null,
              l("a", { href: "#copyright" }, "Copyright Infringement")
            ),
            l(
              "li",
              null,
            ...
            l(
              "li",
              null,
              l("a", { href: "#prights" }, "Proprietary Rights Notices")
            ),
            l(
              "li",
              null,
              l("a", { href: "#disclaimer" }, "Disclaimer of Warranties")
            ),
            l(
              "li",
              null,
              l("a", { href: "#liability" }, "Limitation of Liability")
            ),
            l(
              "li",
              null,
              l("a", { href: "#indemnification" }, "Indemnification")
            ),
            l("li", null, l("a", { href: "#disputes" }, "Disputes")),
            l("li", null, l("a", { href: "#governinglaw" }, "Governing Law")),
            l(
              "li",
              null,
              l(
            ...
            l("li", null, l("a", { href: "#termination" }, "Termination")),
            l("li", null, l("a", { href: "#assignment" }, "Assignment")),
            l("li", null, l("a", { href: "#severability" }, "Severability")),
            l(
              "li",
              null,
              l("a", { href: "#relationship" }, "Relationship of the Parties")
            ),
            l("li", null, l("a", { href: "#majeure" }, "Force Majeure")),
            l("li", null, l("a", { href: "#entire" }, "Entire Agreement")),
            l(
              "li",
              null,
              l("a", { href: "#international" }, "International Access")
            ),
            l(
              "li",
              null,
            ...
            l("li", null, l("a", { href: "#children" }, "Access by Children")),
            l(
              "li",
              null,
              l("a", { href: "#communication" }, "Electronic Communications")
            ),
            l(
              "li",
              null,
              l("a", { href: "#revisions" }, "Revisions to Agreement")
            ),
            l("li", null, l("a", { href: "#notice" }, "Copyright Notice"))
          ),
          l(
            "p",
            null,
          ...
          l("h5", { id: "service" }, "THE POCKET SERVICE"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "info" }, "INFORMATION YOU PROVIDE"),
          l(
            "p",
            null,
            "You agree to read our ",
            l("a", { href: "/privacy" }, "Privacy Policy"),
          ...
          l("h5", { id: "copyright" }, "COPYRIGHT INFRINGEMENT"),
          l(
            "p",
            null,
          ...
          l(
            "p",
            null,
            "If you believe that your copyrighted work or trademark has been infringed, please contact us and provide all information relevant to any claim of copyright or trademark infringement. Please contact us as described on our",
            " ",
            l(
              "a",
              { href: "/report_infringement" },
          ...
          l(
            "p",
            null,
            "If you have developed a software application and are interested in integrating such application with the Pocket Technologies, you must enter into our",
            " ",
            l(
              "a",
              { href: "http://getpocket.com/developer/docs/tos" },
              "API License Agreement"
            ),
            ". Please contact us at legal@getpocket.com for additional information."
          ),
          l("h5", { id: "prights" }, "PROPRIETARY RIGHTS NOTICES"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "disclaimer" }, "DISCLAIMER OF WARRANTIES"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "liability" }, "LIMITATION OF LIABILITY"),
          l(
            "p",
            null,
            l(
          ...
          l("h5", { id: "indemnification" }, "INDEMNIFICATION"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "governinglaw" }, "GOVERNING LAW"),
          l(
            "p",
            null,
          ...
          l(
            "p",
            null,
            "Subscriptions to our paid Pocket Premium service are available on monthly and yearly subscription plans. Each paid subscription is valid for only one user account and you are not permitted to use your paid subscription with any other user accounts.",
            " ",
            l(
              "strong",
              null,
              "YOUR PAID POCKET PREMIUM SUBSCRIPTION WILL BE AUTOMATICALLY RENEWED, AND THE SUBSCRIPTION FEE CHARGED, AT THE END OF EACH SUBSCRIPTION PERIOD UNTIL YOU CANCEL. THE SUBSCRIPTION FEE WILL BE CHARGED TO YOUR LAST PAYMENT METHOD."
            ),
            " ",
            "We may offer a free trial period for Pocket Premium. If you sign up for a free trial, you will be charged the subscription fee when the free trial period ends, and at the end of each subsequent subscription period until you cancel."
          ),
          l(
            "p",
            null,
          ...
          l("h5", { id: "termination" }, "TERMINATION"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "severability" }, "SEVERABILITY"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "relationship" }, "RELATIONSHIP OF THE PARTIES"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "entire" }, "ENTIRE AGREEMENT"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "international" }, "INTERNATIONAL ACCESS"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "govtrights" }, "U.S. GOVERNMENT RESTRICTED RIGHTS"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "children" }, "ACCESS BY CHILDREN"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "communication" }, "ELECTRONIC COMMUNICATIONS"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "revisions" }, "REVISIONS TO AGREEMENT"),
          l(
            "p",
            null,
          ...
          l("h5", { id: "notice" }, "COPYRIGHT NOTICE"),
          l(
            "p",
            null,
            "Copyright \xa9 2012-",
            new Date().getFullYear(),
            " Read It Later, Inc. All rights reserved."
          )
        );
      }
      h.getInitialProps = Object(n.a)(
        r.a.mark(function e() {
...
//# sourceMappingURL=tos-8e295416e8bd40e82495.js.map
